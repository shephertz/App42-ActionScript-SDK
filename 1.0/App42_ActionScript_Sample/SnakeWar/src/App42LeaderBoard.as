...
var serviceAPI:ServiceAPI = new ServiceAPI("YOUR API KEY","YOUR SECRET KEY");
...
class saveUserScoreCallBack implements App42CallBack{
	...
	public function onException(exception:App42Exception):void
	{
		if(exception.getAppErrorCode() ==3002){
			...
			gameService.createGame(gameName,"Game is successfully created",new gameCallBack());
		}
		else{
			App42Log.debug("Exception is : " + exception);
		}
	}
}

class gameCallBack implements App42CallBack{
	...
	public function onSuccess(res:Object):void
	{
		...
		if(res is Game)
		{
			...
			if(game.getName()!=null){
				...
				scoreBoardService.saveUserScore(gameName,userName,GameOver.score,new saveUserScoreCallBack());
			}
		}
	}
	public function onException(excption:App42Exception):void
